...
<div class="form-container">
  <form action="/Account/login-process.php" method="POST" class="max-w-sm mx-auto login" id="loginForm">
    <div class="mb-5">
  ...
  <form action="/Account/register.php" method="POST" class="max-w-sm mx-auto register" id="registerForm">
    <div class="mb-5">
