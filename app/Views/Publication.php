...
<body>
    <div class="container">
        ...
        <form action="/../../app/Views/Account/Publication-process.php" method="POST" id="publication-form">
            ...
            <input type="text" id="date-depart" name="date-depart" class="datetimepicker" required>

            <label for="date">Date et heure estimés d'arriver :</label>
            <input type="text" id="date-arriver" name="date-arriver" class="datetimepicker" required>
